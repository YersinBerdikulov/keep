...
class AddBoxMemberPage extends HookConsumerWidget {
  final BoxModel boxModel;

  const AddBoxMemberPage({super.key, required this.boxModel});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'All group members have already been added to this box',
        ...
        child: Column(
          children: [
                                ...
                                children: [
                                  GridView.builder(
                                    ...
                                    itemBuilder: (context, i) {
                                      ...
                                      // Get the friend's name and profile pic based on who is the current user
                                      final friendName =
                                          friend.sendRequestUserId ==
                                                  currentUserId
            ...
            Container(
              ...
              child: ButtonWidget(
                isLoading:
                    ref.watch(boxNotifierProvider(boxModel.groupId)).maybeWhen(
                          loading: () => true,
                          orElse: () => false,
                        ),
                onPressed: () {
